...
<body class="originalblue" style="background-color: #06ccf6">
<!--<body class="originalblue">-->

<!--<span style="margin-left: 1500px;" style="background-color: #06ccf6" title="For any issue regarding this Zabbix Reporting portal, kindly drop a mail to MS.Monitoring@jda.com"><?php echo "Info"; ?></span> -->

<input type="button" value="Info" style="margin-left: 1100px; text-align:right; background-color: #ffaa08; font-size:16px; color:#000" onclick="alert('For any issue regarding this Zabbix Reporting portal,\nkindly drop a mail to MS.Monitoring@jda.com \n\nIn case of Emergency kindly dial ext.-8400');"/>


<div id="message-global-wrap"><div id="message-global"></div></div>
<table class="maxwidth page_header" cellspacing="0" cellpadding="5"><tr><td class="page_header_l"><a class="image" href="https://blueyonder.com/" target="_blank"><div class="zabbix_logo">&nbsp;</div></a></td><td class="maxwidth page_header_r">&nbsp;</td></tr></table>


<br/><br/>
<!-- <center><h1>Generate PDF Report</h1></center> -->
<center><h1 style="margin-top: 10px;font-size: 20px;">Generate Utilization Report for Host & Host Group in PDF</h1></center>
<center><h1 style="font-size: 20px;">Report Time Zone : <?php echo $timezone ?> [<b>UTC</b>]</h1></center>
<br/>
<?php
// ERROR REPORTING
...
$host_groups = ZabbixAPI::fetch_array('hostgroup','get', array('output'=>array('groupid','name'),'with_monitored_hosts' => true,'sortfield'=>'name') )
	or die('Unable to get hosts: '.print_r(ZabbixAPI::getLastError(),true));
...
<table border="4" rules="NONE" frame="BOX" height="200" cellpadding="10" style="background-color: #fff; width: 720px;">
<tr><td valign="middle" align="left" width="20">
<!-- <label for="ReportType"><b>Report type</b></label> -->
</td><td valign="center" align="left" height="10">
<p>
...
&nbsp;
</td><td valign="center" align="left" width="70" height="10">
...
</td><td valign="right" align="left">
<input type='submit' value='Generate'>
<!--<input type='submit' value='Generate' style="background-color: #a1eef5; border: 2px solid black; margin:0 auto;">-->
</p>
<!--</td><td valign="right" align="left">
<input type='submit' value='Generate'> -->
